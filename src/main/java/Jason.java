        ...
        while (!exit) {
            ...
            try {
                if (cmd.equals("bye") && contents.isEmpty()) {
                    ...
                    if (contents.isEmpty()) throw new EmptyException();
                    ...
                    if (contents.isEmpty() || !contents.toLowerCase().contains("/by")) throw new IncorrectInputException();
                    String[] parts = contents.split("/by", 2);
                    String desc = parts[0].trim();
                    String byStr = parts.length > 1 ? parts[1].trim() : "";
                    if (desc.isEmpty() || byStr.isEmpty()) throw new EmptyException();
                    ...
                    if (fromIdx < 0 || toIdx < 0) throw new IncorrectInputException();
                    ...
                    if (desc.isEmpty() || fromS.isEmpty() || toS.isEmpty()) throw new EmptyException();
                    ...
                    if (to.isBefore(from)) to = to.plusDays(1);
                    ...
                    if (idx < 0 || idx >= tasks.size()) throw new OobIndexException();
                    tasks.mark(idx);
